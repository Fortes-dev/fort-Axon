...
class Bonus(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, type):
        ...
        match self.type:
            case ('speed'):
                imagen = pygame.transform.rotozoom(pygame.image.load(constants.BONUS_SPEED_INCREASE_0), 0, constants.BONUS_ZOOM)
            ...
            case ('bullet'):
                imagen = pygame.transform.rotozoom(pygame.image.load(constants.BONUS_CHARGED_SHOT_0), 0, constants.BONUS_ZOOM)
            ...
            case ('firerate'):
                imagen = pygame.transform.rotozoom(pygame.image.load(constants.BONUS_FIRE_RATE_0), 0, constants.BONUS_ZOOM)
