...
class Scoreboard():
    ...
    def draw_scoreboard_player_1(self, life):
        ...
        self.game.window.blit(self.font.render("{0}".format(self.game.score), 1, self.game.WHITE), (275, 30))
        self.game.window.blit(self.font.render(" x {0}".format(self.game.player.charged_shot_ammo), 1, self.game.WHITE), (545, 30))
    ...
    def draw_scoreboard_player_2(self, life):
        ...
        self.game.window.blit(self.font.render("{0}".format(self.game.score), 1, self.game.WHITE), (275, self.game.DISPLAY_H - 50))
        self.game.window.blit(self.font.render(" x {0}".format(self.game.player.charged_shot_ammo), 1, self.game.WHITE), (545, self.game.DISPLAY_H - 50))
